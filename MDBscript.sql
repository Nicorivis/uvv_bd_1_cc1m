DROP USER IF EXISTS 'nicolasperim'@'localhost';
CREATE USER 'nicolasperim'@'localhost' IDENTIFIED BY '123456';
GRANT ALL ON DATABASE uvv TO 'nicolasperim'@'localhost';
...
alter table funcionario                         add constraint c_MF check(sexo in ('F','M'))
;
...
INSERT INTO elmasri.funcionario
(cpf, primeiro_nome, nome_meio, ultimo_nome, data_nascimento, endereco, sexo, cpf_supervisor, salario, numero_departamento)
VALUES('88866555576', 'Jorge', 'E', 'Brito', '1937-11-10', 'Rua do Horto,35, São Paulo,SP', 'M', '', 55.000, 1);
